...
<root>
    <truths>
        <truth>
            ...
            <contents>Truth contents text</contents>
            <relatesTo>
...
- `approvedBy` - zero or more `<by>` entries, each `Human` or `AI`.
- `contents` - free text: the body of the truth.
...
- A truth may leave any field empty; empty elements are written as `<contents></contents>`.
