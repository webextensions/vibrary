...
- Replace the template-specific intro and links with your project's own documentation. Keep (or
  trim) the pointer to [docs/README.md](../../README.md) - the documentation index stays useful -
  and the template-sync workflow
  ([docs/template-project/template-sync.md](../../template-project/template-sync.md)) for pulling
